...
const deletePlan = () => {
    if (props.plan && !processing.value) {
...
<template>
    <button class="btn btn-delete" @click="isOpen = true">
        Delete
    </button>
    <Teleport to="body">
        <div id="deletePlanModal" class="modal" :class="{ 'active': isOpen }">
            <div class="modal-content">
                ...
                <div class="delete-confirmation">
                    ...
                    <div class="confirmation-content">
                        <h3 class="confirmation-title">Are you sure you want to delete this plan?</h3>
                        <p class="confirmation-message">
                            This action will permanently delete the plan
                            <strong>"{{ plan?.name }}"</strong>
                            with price <strong>${{ plan?.price }}</strong>
                            ({{ plan?.billing_period }}).
                        </p>
                        <p class="warning-text">
                            This action cannot be undone. All users subscribed to this plan may be affected.
                        </p>
                    </div>
                </div>
                ...
                <div class="modal-actions">
                    ...
                    <button type="button" class="action-button danger-button" @click="deletePlan"
                        :disabled="processing">
