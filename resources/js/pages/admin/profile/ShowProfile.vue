...
import UpdateAdminProfileController from '@/actions/App/Http/Controllers/AdminProfile/UpdateAdminProfileController';
import UpdateImageAdminProfileController from '@/actions/App/Http/Controllers/AdminProfile/UpdateImageAdminProfileController';
...
function handleChangePicture(event: Event) {
    ...
    if (file) {
        ...
        router.post(UpdateImageAdminProfileController(), { image: file }, {
            onSuccess: () => {
    ...
    <AdminDashboardLayout title="My Account" headerTitle="My Account">
        <div style="max-width: 600px; margin: 0 auto;">
            ...
            <Form v-bind="UpdateAdminProfileController.form()" :reset-on-success="['password', 'password_confirmation']"
                v-slot="{ errors, processing }" :options="{ preserveScroll: true, preserveState: true }"
                ...
                <div class="form-group-custom">
                    ...
                    <input type="password" class="form-control-custom" id="userPassword" name="password"
                        v-model="password" placeholder="Enter new password (optional)">
                ...
                <div class="form-group-custom">
                    ...
                    <input type="password" class="form-control-custom" id="confirmPassword" name="password_confirmation"
                        v-model="password_confirmation" placeholder="Confirm new password">
