...
<template>
    <Head :title="`${user.username} — Movies`" />
        ...
        <div class="public-channel-content">
            ...
            <main class="channel-content-area">
                <div class="content-grid active">
                    <div v-for="movie in movies" :key="`movie_${movie.id}`" class="content-card" @click="handleContentClick($event)">
                        <template v-if="authUser">
                            <Link :href="`/movie/${movie.contentable.id}`">
                                <img :src="movie.contentable.vertical_image_url" alt="Content" />
                            </Link>
                        </template>
                        <template v-else>
        ...
        <div v-if="showLoginModal" class="modal-backdrop" @click.self="closeLoginModal">
            <div class="login-modal">
                ...
                <p class="modal-subtitle">
                    Create an account or log in to watch movies, follow creators, and more.
                </p>
