...
function deleteSerie() {
    ...
    router.delete(DestroySerieController({ serie: props.serie.id }), {
        preserveScroll: true,
        onSuccess: () => {
...
<template>
    ...
    <teleport to="body">
        <div id="deleteSerieModal" class="modal" :class="{ 'active': isOpen }">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="modal-title" id="deleteSerieModalTitle">Delete Serie</h2>
                    <button class="close-modal-btn" id="closeDeleteSerieModal" @click="isOpen = false">&times;</button>
                </div>
                
                <div class="modal-body">
                    <p class="warning-text">
                        Are you sure you want to delete "<strong>{{ serie.title }}</strong>"?
                    </p>
                    <p class="warning-subtitle">
                        This action cannot be undone. The serie and all its seasons and episodes will be permanently removed from your channel.
                    </p>
                </div>

                <div class="modal-actions">
                    <ActionButton type="button" class="action-button" id="cancelDeleteSerie"
