...
import ShowEditMovieController from '@/actions/App/Http/Controllers/Movie/ShowEditMovieController';
...
function goToEditMovie() {
    router.visit(ShowEditMovieController({movie: props.movie.id}));
...
<template>
    <div class="content-card">
        ...
        <div class="options-dropdown" :class="{ 'show': isDropdownOpen }">
            <button @click="goToEditMovie">Edit</button>
