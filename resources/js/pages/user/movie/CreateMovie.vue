...
watch(categorySelected, (newVal) => {
    ...
    if (props.movie.subcategory_id) {
        subcategorySelected.value = props.movie.subcategory_id;
    }
});
        ...
        <div class="main-content">
            ...
            <template v-if="isCanPublish">
                ...
                <Form v-bind="PublishMovieController.form(movie)"
                    ...
                    class="upload-form active" style="margin-bottom: 80px;">
            ...
            <template v-else>
                <div class="limit-reached-container">
                    ...
                    <p class="limit-description">
                        You've reached the maximum number of movies allowed for your current plan ({{ moviesCount }}/{{ plan.movies_upload_count }}). 
                        Upgrade your subscription to continue uploading movies.
                    </p>
                    <div class="limit-actions">
                        <button type="button" class="upgrade-btn" @click="router.visit(ShowManageSubscriptionProfileController())">
                            Upgrade Plan
                        </button>
                    </div>
                </div>
