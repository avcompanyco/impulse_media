...
import {create as createRoute, edit as editRoute} from '@/routes/user/upload/serie'
...
function goToCreateSerieForm() {
    router.visit(createRoute.url());
}

function goToEditSerieForm() {
    router.visit(editRoute.url());
}
        ...
        <div class="main-content" style="margin-bottom: 80px;">
            ...
            <div class="series-management-container">
                <div id="seriesInitialChoice" class="series-choice-buttons">
                    <button type="button" class="choice-btn" id="createNewSerieBtn" @click="goToCreateSerieForm">
                        <h3>Create New Serie</h3>
                        <p>Start a brand new series from scratch.</p>
                    </button>
                    <button type="button" class="choice-btn" id="manageSerieBtn" @click="goToEditSerieForm">
                        <h3>Manage Existing Serie</h3>
                        <p>Add seasons or episodes to a serie you already created.</p>
                    </button>
                </div>
            </div>
