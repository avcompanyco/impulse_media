...
const hasImage = computed(() => {
    return props.chapter.thumbnail || previewImage.value;
});

const imageUrl = computed(() => {
    return previewImage.value || props.chapter.thumbnail_url;
});
...
function removeImage () {
    ...
    router.delete(DeleteThumbnailChapterController.url({
        serie: props.serie,
        season: props.season,
...
<template>
    <Form ref="form" v-bind="UploadThumbnailChapterController.form({
        serie: props.serie,
        season: props.season,
        chapter: props.chapter.id,
    })" :reset-on-success="['thumbnail']"
        v-slot="{ errors, processing }" :options="{ preserveScroll: true }"
        v-on:start="isUploading = true"
        ...
        <div class="form-section">
            ...
            >
                ...
                <div v-else class="image-preview-container">
                    <img :src="imageUrl" alt="Episode Thumbnail" class="image-preview"/>
            ...
            <input 
                ...
                :disabled="isDisableUpload"
            >
            <ErrorLabel :error="errors.thumbnail" />
        </div>
    </Form>
</template>
