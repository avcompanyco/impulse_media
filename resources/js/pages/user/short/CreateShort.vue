...
import PublishShortController from '@/actions/App/Http/Controllers/Short/PublishShortController';
    ...
    <UserDashboardLayout 
        ...
        <div class="main-content">
            ...
            <div class="toggle-container">
                ...
                <button class="toggle-btn active" data-form="short" @click="goToShortForm">Short</button>
            </div>

            <template v-if="isCanPublish">
                <UploadShortForm v-model="shortRef" />
                <Form id="shortForm" v-bind="PublishShortController.form(short)" :reset-on-success="['text_caption']"
                    style="margin-bottom: 80px;" v-slot="{ errors, processing }" :options="{ preserveScroll: true }"
            ...
            <template v-else>
                <div class="limit-reached-container">
                    ...
                    <p class="limit-description">
                        You've reached the maximum number of shorts allowed for your current plan ({{ shortsCount
                        }}/{{ plan.shorts_upload_count }}).
                        Upgrade your subscription to continue uploading shorts.
                    </p>
