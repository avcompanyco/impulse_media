...
async function run() {
    console.log('Launching headless Chrome with user profile...');
    ...
    console.log('Waiting 20 seconds for terminal to load...');
    await delay(20000);

    const screenshotPath = '/Users/antoniovarona/Desktop/impulse_media/scratch/aws_terminal_test.png';
